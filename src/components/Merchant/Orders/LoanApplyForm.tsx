                    ...
                    {showValue && (
                        <AccordionItem>
                            ...
                            <p className="my-2 text-lg">
                                        <span className="text-lg">Name : </span>  <span className='text-blue-600'>  {details.name} </span>
                                    </p>
                                    <p className="my-2 text-lg">
                                        <span className="text-lg">Phone Number : </span> <span className='text-blue-600'> {details.phone}</span> 
                                    </p>
                                    <p className="my-2 text-lg">
                                        <span className="text-lg  ">Eligibility : </span > <span className='text-green-500'> ₹15,000 </span> 
                                    </p>
                                </div>
                                {/* ==================form  */}
